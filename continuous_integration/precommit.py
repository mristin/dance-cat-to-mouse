...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "dancecattomouse").glob("**/*.py"):
    ...
    if (
        ...
        print("Checking that dancecattomouse/__init__.py and setup.py coincide...")
        exit_code = call_and_report(
            verb="check that dancecattomouse/__init__.py and setup.py coincide",
            cmd=[
                sys.executable,
        ...
        print(
            "Skipped checking that dancecattomouse/__init__.py and setup.py coincide."
        )
